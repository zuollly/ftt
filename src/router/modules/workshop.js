  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'trainingShow/:activityId', component: () => import('@/views/training/trainingShow'), name: 'trainingShow', hidden: true, meta: { title: '培训详情', icon: 'training-show', requireAuth: true }
        }
      ]
    },
    {
      ...
      hidden: true,
      meta: {
        title: '修改工作坊', icon: '', requireAuth: true
      }
    }
  ]
}
