  ...
  <div class="">
    <div class="activityWrapper">
      ...
      <el-row class="contentWrapper" :gutter="15">
        ...
        <el-col class="train-right" :span="18">
          <div class="divWrapper">
            <component :currentStep.sync='currentStep' :is="activityComponent"></component>
          </div>
        </el-col>
...
<script>
import { getStageId, activityStepList } from '@/api/activityCopy.js'
import { fetchActivityMember } from '@/api/member.js'
export default {
  components: {
    BasicMessage: () => import('./modules/BasicMessage.vue'),
    activityContent: () => import('./modules/activityContent.vue'),
