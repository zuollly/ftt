  ...
  <div class="">
    <div class="activityWrapper">
      ...
      <el-row  class="contentWrapper" :gutter="15">
        ...
        <el-col class="train-right" :span="20">
          <div class="divWrapper">
            <!-- <component :currentStep.sync='currentStep' :is="activityComponent" :holderInfo="holder"></component> -->
            <BasicMessage :holderInfo="holder"></BasicMessage>
            <activityContent :currentStep.sync='currentStep' :holderInfo="holder"></activityContent>
          </div>
        </el-col>
