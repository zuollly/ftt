<template>
  <div class="activityContent">
    ...
    <div class="N-content">
      ...
      <courseContent v-if="courseList.length" :courseList='courseList'></courseContent>
      <homeWorkDetails v-if="homeWorkList.length" :homeWorkList='homeWorkList'></homeWorkDetails>
      <homeWorkContent v-if="homeWorkList.length" :homeWorkList='homeWorkList'></homeWorkContent>
      ...
      <div v-if="vedioList.length" class="mb-3">
        <el-button type="success" @click="getIntoVedio" size="small">进入教研</el-button>
        <div>
...
export default {
  ...
  components: {
    homeWorkContent: () => import('./homeWorkContent.vue'),
