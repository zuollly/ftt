    ...
    <el-row class="notice-details-main" :gutter="10">
      <el-col class="home-details" :xs="24" :sm="24" :md="8" :lg="7" :xl="6">
        <div class="informationWrapper bg-white mb-2 border-shadow">
          <chooseCard :src='src' :jumpType='"notice"' :chooseType='chooseType' :list='chooseList'></chooseCard>
        </div>
      </el-col>
    ...
    >
      ...
      >
        <el-form-item label="公告标题" prop="title">
          <el-input v-model="contentForm.title" placeholder="请输入公告标题"></el-input>
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      src: `${appConfig.cfg_fileBasehost}notice.jpg`,
  ...
  methods: {
    addContent() {
      const data = {
        ...
        userId: this.uuid,
        relevance: {
          contentTypeCode: 'CONTENT_STATIONNEWS_BULLETIN',
