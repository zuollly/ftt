<template>
  <div class="lay-login">
    <div class="lay-login-container" :style="style">
      <div class="lay-login-header" @click="gotoIndex" style="cursor: pointer" title="返回首页">
          <img class="lay-login-header-logo" :src="appConfig.cfg_weblogo"/>
          <span class="lay-login-header-title">{{appConfig.cfg_webname}}</span>
      </div>
      <div class="lay-login-header-desc">{{appConfig.cfg_webslogan}}</div>
      <el-form class="lay-login-form" :style="getLoginStyle" autoComplete="on" :model="loginForm" :rules="loginRules" ref="loginForm" label-position="left">
        ...
        <!--<div class="d-flex p-1 mb-3">-->
          ...
          <!--<div><a :href="appConfig.cfg_forget_path" class="text-primary" target="_blank">忘记密码？</a></div>-->
        <!--</div>-->

        <el-button type="primary" style="width:100%;margin-bottom:30px;" :loading="loading" @click.native.prevent="handleLogin">登录</el-button>

        <!--<div class="d-flex">-->
          <!--<div class="p-1"><a :href="appConfig.cfg_register_path" class="text-primary" target="_blank">用户免费注册 </a></div>-->
        <!--</div>-->
      </el-form>
    </div>
  </div>
